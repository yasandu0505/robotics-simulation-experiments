...
2. **Navigate into the project folder**
   ...
   ```bash
   cd robotics-simulation-experiments/robot-navigation-on-straight-line
   ```
...
3. **Open the project in Webots**
   ...
   - Browse to the project folder and select the `.wbt` `robot-navigation-on-straight-line/worlds/apartment.wbt`
   - Click **Open**
